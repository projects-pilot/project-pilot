...
//   return (
//     <motion.div ref={ref} className={cn("sticky inset-x-0 top-8 z-40 w-full", className)}>
...
//       }}
//       style={{
//         minWidth: "320px", // Changed from 800px for better mobile support
//       }}
//       className={cn(
...
//           onClick={onItemClick}
//           className="relative px-4 py-2  font-sora font-bold text-black dark:text-neutral-300"
//           key={`link-${idx}`}
//           href={item.link}
//         >
//           {hovered === idx && (
